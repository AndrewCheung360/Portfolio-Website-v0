...
export default function NavWindow({scrollTo}) {
    ...
    const links = [
        ...
        {
            title: "Resume",
            href: "https://drive.google.com/file/d/1i4_e0rPOXiEjo1hd_iooSgE_2jK3GmvY/view?usp=sharing"
        }
    ]
    ...
    return (
      <div className= "flex flex-col justify-between pt-[40px] px-[30px] sm:pt-[60px] sm:px-[40px] sm:pb-[50px] h-full box-border">
