...
export default function FooterButtons() {
    return(
        <div className = "flex flex-row items-center w-full justify-center gap-x-8 sm:gap-x-40 2xl:gap-x-64">
            ...
            <MagneticFramer>
                <a href = {resume} target="blank"  className = "group relative bg-[#fffcf0] rounded-[36px] py-4 flex justify-center gap-x-3 items-center px-6 cursor-pointer overflow-hidden w-28 sm:w-32 xl:w-44">
